...
Execute unit tests
```
    cd "dotnet10__al2023__lambda__native__aot/test/dotnet10__al2023__lambda__native__aot.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "dotnet10__al2023__lambda__native__aot/src/dotnet10__al2023__lambda__native__aot"
