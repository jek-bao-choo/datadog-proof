...
## USE CONTEXT7 FOR MORE CONTEXT INFORMATION
...
- Finally, my overarching goal is to add tracing capability to my .NET 10 Lambda Native AOT function.
  - I want to enable opentelemetry-dotnet dependency for distributed tracing (thereby sending the spans telemetry to Datadog) with .NET handler via NuGet approach.
  - I want to send my telemetry to an OTLP endpoint - ask me for it.
  ...
  <!-- - If dd-trace-dotnet doesn't provide me with distributed tracing observability, then  -->
